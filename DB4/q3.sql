...
SELECT ls.student_number, ls.student_name
FROM lecture_special ls
LEFT JOIN lecture_basic lb ON ls.student_number = lb.student_number AND ls.student_name = lb.student_name
WHERE lb.student_number IS NULL;
