...
INSERT INTO emp(name,job,birthdate,sal,deptno) VALUES ('SMITH','CLERK',STR_TO_DATE('17-12-1990','%d-%m-%Y'),900,10);
INSERT INTO emp(name,job,birthdate,sal,deptno) VALUES ('ALLEN','SALESMAN',STR_TO_DATE('20-2-1982','%d-%m-%Y'),1600,20);
